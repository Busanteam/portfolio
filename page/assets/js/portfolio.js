(function () {
    ...
    const translations = {
        ko: {
            ...
            'about.p3': '디자인·개발·기획이 겹치는 구간에서 요구사항을 정리하고, 구현 가능성과 우선순위를 맞춰 합의를 빠르게 끌어냅니다. 한쪽 역할에만 묶이지 않고 제품을 끝까지 밀어 가는 쪽에 가깝습니다.',
        ...
        en: {
            ...
            'about.p3': 'At the intersection of design, engineering, and planning, I clarify requirements, align feasibility and priorities, and drive decisions so delivery keeps moving. I don’t stay confined to a single lane—I take ownership through to ship.',
