(function () {
    ...
    const translations = {
        ko: {
            ...
            'about.title': '소개',
            'about.quote.sub': '불가능한 문제는 없고',
            'about.quote.main': '도전만이 정답일 뿐',
            'about.p1': '디자인, 개발, 3D 작업을 꾸준히 해 왔고, 그 과정에서 <b>8번</b> 상을 받았습니다. <b>2017년</b>부터 기업 외주·프리랜스도 이어 오고 있습니다.',
            'about.p2': '<b>200건 넘는</b> 프로젝트를 해 왔지만, 지금도 새로운 일을 찾고 있습니다. 의뢰하신 분이 원하는 방향을 잘 듣고, 제 방식만 고집하지 않습니다.',
            'about.p3': '가장 자신 있는 건 소통입니다. 특히 먼저 듣는 편입니다. UX/UI 일을 시작했을 때 팀과 잘 맞는 성격이 큰 도움이 됐고, 개발도 공부해 둔 덕분에 개발자와도 말이 잘 통했습니다. 기획 팀이 바쁠 때도 같이 고민하고, 더 나은 방향을 제안하는 쪽으로 일했습니다.',
            ...
            'apple.desc': '2024년과 2026년 Apple Korea GP 프로젝트에 참여했습니다. 애플 스타일의 미니멀한 화면·그래픽 작업이었습니다.',
            'apple.nda': 'NDA 때문에 자세한 내용은 공개할 수 없습니다. 면접 때 말씀드릴 수 있는 범위 안에서 설명드리겠습니다.',
        ...
        en: {
            ...
            'about.quote.sub': 'There are no problems',
            'about.quote.main': 'Only challenges',
            'about.p1': 'I have worked steadily to enhance my abilities across design, development, and 3D tools, and I have received <b>8 awards</b> for using these abilities. Based on this experience, I have been freelancing for companies outsourcing <b>since 2017.</b>',
            'about.p2': 'I have had more than <b>200 freelance experiences,</b> but I am always looking for new challenges. I am adept at communicating about the desired design with various customers and am flexible enough not to just stick to my own designs.',
            'about.p3': 'My greatest strength is communication, but especially my listening skills. When I first began working in the UX/UI field, I found my ability to communicate was a huge advantage, along with my propensity for teamwork. I had studied development previously, so I knew about structure and operations, and it was easy for me to communicate effectively with developers. So, even when the planning team of the same department was backed up or busy solving issues, I often contributed to the project by helping the team to think about it together and conceive of ideas to push the project in a better direction.',
