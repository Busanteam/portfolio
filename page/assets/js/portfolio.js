(function () {
    ...
    const translations = {
        ko: {
            ...
            'exp.5.desc': 'Apple Korea GP 요구에 맞춰 웹 시각 산출물을 검수부터 제작·납품까지 진행했습니다. 타이포·여백 기준으로 완성도를 맞췄습니다.',
            ...
            'exp.7.desc': '2024년 이후 재섭외되어 Apple Korea GP를 이어갔습니다. 동일 완성도 기준으로 웹 시각 산출물을 제작·납품했습니다.',
            'proj.title': '주요 프로젝트',
            'bub.title': 'Bub Diary',
        ...
        en: {
            ...
            'exp.5.date': '2024. 08 - 2024. 09',
            'exp.5.desc': 'Took Apple Korea GP requirements from review through production and delivery of web visual assets. Matched typography and spacing standards for visual fidelity.',
            ...
            'exp.7.desc': 'Re-engaged after 2024 for Apple Korea GP. Produced and delivered web visual assets to the same quality bar.',
