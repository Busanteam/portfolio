(function () {
    ...
    const translations = {
        ko: {
            ...
            'meta.description': '시각 디자인부터 웹·앱 개발, 서비스 기획·운영까지. 김영훈 포트폴리오.',
            ...
            'hero.desc': '시각 디자인부터 서비스 설계·개발·운영까지.<br>완성도 높은 UI와 안정적인 구현으로 실제로 쓰는 제품을 만듭니다.',
            'hero.connect': "Let's Connect",
            'hero.resume': 'Download Resume',
            'about.title': '소개',
            'about.quote.sub': '불확실할수록',
            'about.quote.main': '기준을 먼저 잡습니다',
            'about.p1': '디자인·개발·3D를 아우르는 실무를 이어 왔습니다. 관련 수상 <b>8회</b>, 기업 외주·프리랜스는 <b>2017년</b>부터 진행 중입니다.',
            'about.p2': '<b>250건 이상</b>의 의뢰를 수행했습니다. 요구사항을 우선으로 정리하고, 디자인 기준과 실행 가능 범위를 맞춰 결과물로 마감합니다.',
            'about.p3': '디자인·개발·기획이 겹치는 구간에서 요구사항을 정리하고, 구현 가능성과 우선순위를 맞춰 의사결정을 끌어냅니다. 단일 역할에 머물지 않고 출시까지 책임집니다.',
            ...
            'exp.1.desc': '시각디자인 전공, GTQ 1급. AutoCAD·3D 프린터로 건축물·의료용 캐뉼라 부품 도면·출력까지 다루며 설계와 제작을 연결합니다.',
            ...
            'exp.3.desc': '시각디자인 기반으로 250건 이상의 프리랜스·외주를 수행했습니다. 기획, UI/UX, 영상 편집까지 확장해 결과물을 납품했습니다.',
            'exp.4.title': '태양광 사업 UI·UX 디자이너',
            'exp.4.date': '2023. 02 - 2024. 05',
            'exp.4.desc': '에너지 서비스의 복잡한 전력 데이터를 역할별로 읽히게 UI/UX를 설계했습니다. 기획부터 프론트엔드 구현까지 담당하며 운영 화면을 개선했습니다.',
            'exp.5.title': 'Apple Korea GP (프리랜서)',
            'exp.5.date': '2024. 08 - 2024. 09',
            'exp.5.desc': 'Apple Korea GP로 웹 시각 산출물을 제작했습니다. 타이포·여백 기준으로 완성도를 맞춰 납품했습니다.',
            'exp.6.title': '의료용품 회사 개발/디자인 팀장',
            'exp.6.date': '2025. 03 - 2026. 06',
            'exp.6.desc': '팀장으로서 2,500종 이상 의료·복지용품 판매와 직결된 디자인·개발을 총괄했습니다. 엑셀 데이터 마이그레이션과 웹·서버 구축을 리딩했고, 기획 초기부터 물류·마케팅과 맞춰 운영 병목을 줄였습니다.',
            'exp.7.title': 'Apple Korea GP (프리랜서)',
            'exp.7.date': '2026. 07 - 2026. 09',
            'exp.7.desc': '2024년 이후 재섭외되어 Apple Korea GP 작업을 이어갔습니다. 동일한 완성도 기준으로 웹 시각 산출물을 납품했습니다.',
            'proj.title': '주요 프로젝트',
            'bub.title': 'Bub Diary',
            'bub.label': 'Full-Stack · Product Design',
            'bub.desc': '부모·가족이 함께 쓰는 모바일 우선 아기 케어 다이어리입니다. 빠른 기록, 파스텔·다크 모드, 11개 언어를 지원하며 Next.js + Supabase + Vercel로 설계·배포했습니다.',
            'bub.b1': '빠른 기록: 수유(모유/분유/유축/이유식), 기저귀, 체온, 성장, 예방접종·진료, 수면·목욕 등 활동을 한곳에서 기록합니다.',
            'bub.b2': '가족 공유: 초대 코드로 보호자·가족을 초대하고, 아기별 타임라인·통계를 공유합니다.',
            'bub.b3': '다국어: 한국어 기본 + 영어(AU)·중·일·아랍어 등 11개 언어. 아랍어 RTL, 4px 그리드 기반 모바일 UI.',
            'bub.b4': '풀스택 배포: Next.js·TypeScript·Tailwind + Supabase Auth/DB. 이메일 인증 없는 가입 UX, 인앱 제품 투어, 무료 티어 keepalive(cron)까지 구축.',
            ...
            'solar.desc': '5개 서비스의 UI/UX와 브랜드 톤을 설계했습니다. 복잡한 전력 데이터를 관리자·고객 시점으로 나눠 시각화했습니다.',
            'solar.b1': '디자인 시스템: 5개 웹·앱 서비스의 UI 규칙을 통일하고 컴포넌트 기준으로 정리했습니다.',
            'solar.b2': 'PC 모니터링 대시보드: 4px 그리드 반응형 대시보드 — 아래 미리보기로 전체 화면을 확인할 수 있습니다.',
            'solar.b3': '인버터 하드웨어 UX/UI: 7-Segment 발전량 표시기 기획과 일본 진출용 화면·문구 현지화.',
            'solar.b4': 'IP 기반 일본 현지화: 일본 IP 접속 시 언어·단위·통화를 일본 기준으로 자동 전환하도록 구성했습니다.',
            ...
            'biz.desc': '2,500개 이상 품목의 주문·매칭 로직을 자동화하고, 디자인 시스템부터 서버까지 전 과정을 리딩했습니다.',
            'biz.b1': '데이터 인프라: Cafe24 한계를 보완하기 위해 AWS·FastAPI·MySQL 기반 별도 백엔드를 구축했습니다.',
            'biz.b2': '영업 자동화: 조건 기반 복지용구 자동 매칭, 제휴사 코드 URL, 등급별 권한.',
            'biz.b3': '운영 협업: 물류·영업과 요구사항·일정·이슈를 맞춰 납품·운영 지연을 줄였습니다.',
            ...
            'gallery.desc': '브랜드·캠페인·서비스 UI 등 대표 작업과 외부 링크를 모아 두었습니다. 이미지를 선택하면 확대됩니다.',
            ...
            'contact.desc': '협업·채용·프로젝트 문의는 아래 메일 또는 폼으로 남겨 주세요.',
        ...
        en: {
            ...
            'meta.description': 'From visual design to web/app development and service operations. Portfolio of Kim Young Hoon.',
            'nav.theme.light': 'Light Mode',
            'nav.theme.dark': 'Dark Mode',
            'nav.lang': 'KO',
            'toc.intro': 'Intro',
            ...
            'toc.pdf': 'PDF',
            'hero.title': 'Digital Convergence:<br><i style="font-weight:600;color:var(--text-secondary);font-style:normal;">Design & Engineering.</i>',
            'hero.desc': 'From visual design to product design, build, and operations.<br>I ship usable products with polished UI and reliable engineering.',
            'hero.connect': "Let's Connect",
            'hero.resume': 'Download Resume',
            'about.title': 'About Me',
            'about.quote.sub': 'When things are unclear',
            'about.quote.main': 'I set the criteria first',
            'about.p1': 'I work across design, development, and 3D. <b>8 awards</b> along the way, and client freelance work <b>since 2017</b>.',
            'about.p2': 'I’ve delivered <b>250+</b> briefs. I start from requirements, align design standards with what can ship, and close with finished work.',
            'about.p3': 'Where design, engineering, and planning meet, I clarify requirements, align feasibility and priorities, and drive decisions. I don’t stay in one lane—I own delivery through to launch.',
            ...
            'exp.1.title': 'Visual Design & Engineering Tools',
            'exp.1.date': 'Background',
            'exp.1.desc': 'Visual design major, GTQ Level 1. AutoCAD and 3D printing for architectural and medical canula parts—connecting drawings to production.',
            'exp.2.title': 'SSAFY & Alpaco (Academy Projects)',
            'exp.2.date': 'Since 2019',
            ...
            'exp.3.date': '2017. 01 - 2022. 01',
            'exp.3.desc': 'Delivered 250+ freelance briefs on a visual design foundation—planning, UI/UX, and video editing through to handoff.',
            'exp.4.title': 'Solar Energy UI/UX Designer',
            'exp.4.date': '2023. 02 - 2024. 05',
            'exp.4.desc': 'Designed UI/UX so complex energy data is readable by role. Owned planning through frontend implementation for production screens.',
            'exp.5.title': 'Apple Korea GP (Freelance)',
            'exp.5.date': '2024. 08 - 2024. 09',
            'exp.5.desc': 'Produced web visual assets for Apple Korea GP. Delivered against typography and spacing standards for visual fidelity.',
            'exp.6.title': 'Dev/Design Team Lead — Medical Supplies Co.',
            'exp.6.date': '2025. 03 - 2026. 06',
            'exp.6.desc': 'As team lead, owned design and development tied to sales across 2,500+ medical/welfare SKUs. Led Excel data migration and web/server build-out; reduced ops bottlenecks with logistics and marketing from early planning.',
            'exp.7.title': 'Apple Korea GP (Freelance)',
            'exp.7.date': 'Late Jul 2026 - Mid Sep 2026',
            'exp.7.desc': 'Re-engaged after 2024 for Apple Korea GP. Delivered web visual assets to the same quality bar.',
            'proj.title': 'Key Projects',
            'bub.title': 'Bub Diary',
            'bub.label': 'Full-Stack · Product Design',
            'bub.desc': 'A mobile-first baby care diary for parents and family—fast logging, pastel + dark mode, 11 languages. Designed and shipped with Next.js, Supabase, and Vercel.',
            ...
            'bub.b3': 'i18n: Korean default plus English (AU), Chinese, Japanese, Arabic and more (11 locales). Arabic RTL, 4px-grid phone-first UI.',
            'bub.b4': 'Full-stack delivery: Next.js, TypeScript, Tailwind + Supabase Auth/DB. Signup without email confirmation, in-app product tour, and free-tier keepalive via cron.',
            'apple.title': 'Apple KR - iPhone 16 New Release',
            'apple.label': 'Visual Contract · NDA Protected',
            ...
            'solar.label': 'UI/UX Design & Front-end',
            'solar.desc': 'Designed UI/UX and brand tone across 5 services. Visualized complex power data for admin and customer viewpoints.',
            'solar.b1': 'Design system: unified UI rules and components across 5 web/app services.',
            'solar.b2': 'PC monitoring dashboard: 4px-grid responsive dashboard — open the preview below for fullscreen.',
            'solar.b3': 'Inverter hardware UX/UI: 7-segment generation meter UX and Japan-market screen/copy localization.',
            'solar.b4': 'IP-based Japan localization: auto-serve language, units, and currency for Japan IP visitors.',
            'solar.dashboard.title': 'Energy Monitoring Dashboard',
            ...
            'biz.label': 'Service PM & Full-Stack Architect',
            'biz.desc': 'Automated order/matching logic for 2,500+ SKUs and led the stack from design system through backend.',
            'biz.b1': 'Data infrastructure: AWS, FastAPI, and MySQL backend to extend beyond Cafe24 limits.',
            'biz.b2': 'Sales automation: condition-based welfare product matching, partner-code URLs, role-based permissions.',
            'biz.b3': 'Ops alignment: synced requirements, schedule, and issues with logistics and sales to reduce delivery delays.',
            'biz.chart': 'Revenue Growth',
            'biz.flow': 'UX Flow for Product-Auto-Matching',
            'biz.flow.portal': 'UX Flow for Affiliated Client Portal',
            ...
            'gallery.desc': 'Selected brand, campaign, and service UI work with external links. Select an image to enlarge.',
            'gallery.1': 'CI / BI Design',
            'gallery.2': 'App Store Visual',
            'gallery.3': 'SNS Campaign',
            'gallery.4': 'CMYK Branding',
            ...
            'link.bub.github': 'GitHub →',
            'contact.title': 'Get in Touch',
            'contact.desc': 'For collaboration, hiring, or project inquiries, use the form below or email.',
            'contact.name': 'Name or Company',
            'contact.email': 'Email Address',
            'contact.message': 'Tell me about your project...',
            'contact.send': 'Send Message',
